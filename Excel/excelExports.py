...
def ajaArvot(console,lahdeRivit=-1, kohdeRivit=[80,-1], lahde="export_SOK_taulukkovienti_2021-10-27_07-45-20.xlsx", kohde="SOK Käyttötavaroiden erätuotelomake (muut käyttötavarat) v2 33 (version 1) (version 1)_ROSTERi.xlsx",debug=True):
    print(kohdeRivit[0])
...
def clearWorkbook(console, kohdeRivit=[80,500], kohde="SOK Käyttötavaroiden erätuotelomake (muut käyttötavarat) v2 33 (version 1) (version 1)_ROSTERi.xlsx",debug=True):
    columns = {'2. Uutuudet - New articles':["P","R","T","X","AB","AJ","AH","AM","AO","AQ","AS","BR","BS","BT","BW","CQ","CV","CX","DQ","DS","DW","DY","EA","EE","EG","EI","EK","EM","EO","EQ","ES","EV","EX","EZ","FB","FC"],
